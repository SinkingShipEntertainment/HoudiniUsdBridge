...
#
# Use: git checkout <commit-hash> -b <new_branch_name>
# Example (to match Houdini 19.5.535):
# git checkout 5071e59adb7e444e57ae63105c31545f72b02cad -b rez-houdini19.5.535
# --------------------------------------

# NOTE: version = <bridge_version>.sse.<sse_version>
version = "19.5.534.sse.1.0.0"
